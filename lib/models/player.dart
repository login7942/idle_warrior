...
class Player {
  ...
  static const List<Map<String, dynamic>> promotionSteps = [
    ...
    {'lv': 4, 'req': 180, 'name': '정예 기사', 'bonus': '콤보 1,2타 피해 +10%'},
    {'lv': 5, 'req': 240, 'name': '기사단장', 'bonus': '콤보 3타 피해 +10%'},
    {'lv': 6, 'req': 300, 'name': '영웅', 'bonus': '콤보 최종타 피해 +10%'},
    {'lv': 7, 'req': 360, 'name': '전설', 'bonus': '크리티컬 데미지 +15%'},
    {'lv': 8, 'req': 420, 'name': '신화', 'bonus': '최종 피해량 +10%'},
    {'lv': 9, 'req': 480, 'name': '초월자', 'bonus': '스킬 재사용 대기시간 -10%'},
    {'lv': 10, 'req': 540, 'name': '무한의 경지', 'bonus': '모든 능력치 +10%'},
  ];
