...
enum PetGrade {
  ...
  final String name;
  final Color color;
  const PetGrade(this.name, this.color);
...
class PetData {
  static List<Pet> getInitialPets() {
    return [
      ...
      // 2등급 (고급) - 5종
      Pet(id: 'pet_u1', name: '발빠른 토끼', description: '항상 무언가에 쫓기는 듯 빠르게 움직입니다.', grade: PetGrade.uncommon, iconEmoji: '🐰', ownAtkMultiplier: 3.0, ownGoldMultiplier: 5.0, companionSkillName: '가속 점프', companionSkillDesc: '공격 속도가 5% 증가합니다.', companionValue: 5.0),
      ...
      Pet(id: 'pet_r5', name: '날카로운 독수리', description: '하늘 높은 곳에서 적을 사냥합니다.', grade: PetGrade.rare, iconEmoji: '🦅', ownAtkMultiplier: 12.0, ownGoldMultiplier: 10.0, companionSkillName: '급강하 공격', companionSkillDesc: '공격 속도가 15% 증가합니다.', companionValue: 15.0),
      ...
      Pet(id: 'pet_m4', name: '기원 불꽃 주작', description: '하늘을 뒤덮는 거대한 화염 날개를 가진 신수입니다.', grade: PetGrade.mythic, iconEmoji: '🔥', ownAtkMultiplier: 350.0, ownGoldMultiplier: 350.0, companionSkillName: '화염 폭풍', companionSkillDesc: '최종 공격 속도가 30% 증가합니다.', companionValue: 30.0),
