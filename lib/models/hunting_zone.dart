...
class HuntingZoneData {
  static final List<HuntingZone> list = [
    HuntingZone(
      id: ZoneId.grassland,
      name: '초원',
      description: '입문 단계. 빠른 레벨업과 기본 재화 수급 (배율 1.0)',
    ...
    HuntingZone(
      id: ZoneId.forest,
      name: '숲',
      description: '첫 번째 벽. 물리 방어력이 조금씩 상승 (배율 2.0)',
    ...
    HuntingZone(
      id: ZoneId.mine,
      name: '광산',
      description: '본격적인 강화석 파밍 지역. 높은 체력의 적 (배율 4.0)',
    ...
    HuntingZone(
      id: ZoneId.dungeon,
      name: '던전',
      description: '회피와 명중 스탯이 중요해지는 구간 (배율 8.0)',
    ...
    HuntingZone(
      id: ZoneId.volcano,
      name: '화산',
      description: '강력한 공격력. 체력 관리가 핵심인 하드코어 존 (배율 16.0)',
    ...
    HuntingZone(
      id: ZoneId.snowfield,
      name: '설원',
      description: '최상위 옵션이 붙은 신화 장비 드롭 구간 (배율 32.0)',
    ...
    HuntingZone(
      id: ZoneId.abyss,
      name: '심연',
      description: '한계를 시험하는 엔드 콘텐츠 지역 (배율 64.0)',
