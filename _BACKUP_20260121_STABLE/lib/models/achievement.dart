...
class AchievementData {
  static List<Achievement> list = [
    Achievement(
      ...
      targets: List.generate(100, (i) => (10 * pow(i + 1, 1.8)).toInt()),
      rewards: List.generate(100, (i) => 5 + (i * 2)),
    ),
    Achievement(
      id: 'wealthy',
      title: '황금의 손',
      ...
      targets: List.generate(100, (i) => (1000 * pow(i + 1, 2.2)).toInt()),
      rewards: List.generate(100, (i) => 10 + (i * 5)),
    ),
    Achievement(
      id: 'veteran',
      title: '전설의 용사',
      ...
      targets: List.generate(100, (i) => i + 2),
      rewards: List.generate(100, (i) => 1 + (i ~/ 5)),
    ),
    Achievement(
      id: 'hoarder',
      title: '보물 사냥꾼',
      ...
      targets: List.generate(100, (i) => (5 * pow(i + 1, 1.5)).toInt()),
      rewards: List.generate(100, (i) => 2 + i),
    ),
    Achievement(
      id: 'skilled',
      title: '마법의 대가',
      ...
      targets: List.generate(100, (i) => (20 * pow(i + 1, 1.6)).toInt()),
      rewards: List.generate(100, (i) => 3 + i),
    ),
  ];
}
